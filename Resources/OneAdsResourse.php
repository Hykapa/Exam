...
class OneAdsResourse extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'image' => ImageNameResourse::collection($this->images),
            'user' => [
                'id' => $add->user_id,
            ...
            'applications' => OneApplicatonResourse::collection($this->applications)
        ];
    }
}
